...
<body>
  ...
  <header id="header">
    <div class="container-fluid">
      <div id="logo" class="pull-left mt-0">
        ...
        <a href="#intro"><img src="{{ asset ('temp/img/logo_light.png')}}" alt="{{$settings->site_name}}" title="" class="mt-0 logo" /></a>
      </div>
  ...
  <main id="main">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="box">
              ...
              <p class="description">Our affiliate program is a unique opportunity to earn money. Spread the word about {{$settings->site_name}}, bring us new clients, and start earning or even invest your referral earning!</p>
            </div>
          </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row about-cols text-center">
          ...
          <div class="col-lg-3 col-md-4 wow fadeInUp">
            <div class="about-col">
              <div class="img"><img src="{{ asset ('temp/img/about/signup.png')}}" alt="" class="w-25 mt-4"></div>
              <!--<svg class="svg"><use xlink:href="{{ asset ('temp/img/sprite.svg#icon-stable')}}"></use></svg>-->
          ...
          <div class="col-lg-3 col-md-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              <div class="img">
                <img src="{{ asset ('temp/img/about/grow.png')}}" alt="" class="w-25 mt-4">
          ...
          <div class="col-lg-3 col-md-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              <div class="img">
                <img src="{{ asset ('temp/img/about/cashout.png')}}" alt="" class="w-25 mt-4">
    ...
    <section id="awards" class="awards wow fadeInUp section-bg">
        ...
        <img class="show-for-large" src="{{ asset ('temp/img/awards/awards-home.png')}}" alt="Txflux awards" title="Txflux awards">
        <img class="hide-for-large" src="{{ asset ('temp/img/awards/mobile_award.png')}}" alt="Txflux awards" title="Txflux awards">
