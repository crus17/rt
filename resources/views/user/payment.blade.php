											...
											<div class="card-body">
												...
												<div id="btc" class="panel-collapse collapse">
													<div class="">
														...
														<br><img src="{{ asset('home/images/btc_barcode.png')}}" width="200px;"><br/>
														@if($settings->withdrawal_option != "manual")
														<a href="{{ url('dashboard/cpay') }}/{{$amount}}/BTC/{{ Auth::user()->id }}/new" class="mt-2 btn btn-{{$text}}">Automatic payment method</a>
														@endif
														</h4>
													</div>
												</div>
